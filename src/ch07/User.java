...
public class User {
	...
	// 패스워드 체크 기능 만들어 보기
	// 동사로 시작하는 것이 권장 사항
	public String checkPassword(String inputPwd) {
		// 만약 나의 멤버 변수에 들어가 있는
	...
	public static void main(String[] args) {
		...
		// 실행에 흐름 만드는 방법 연습입니다.
		// if 구문을 활용해서 콘솔창에 비밀번호가 틀렸습니다. 출력 하거나
		// 비밀번호가 맞습니다를 출력하시오
		
		String user2Result = user2.checkPassword("134");
		System.out.println(user2Result);
		String user2Result2 = user2.checkPassword("555");
